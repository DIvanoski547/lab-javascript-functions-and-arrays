...
function findLongestWord(words) {
  ...
  for (let i = 0; i < words.length; i++) {
    if (words.length < words[i].length) words = words[i];
  }
  return words;
}
...
const resultAvg = averageNumbers(numbersAvg);
...
const resultsWordsArr = averageWordLength(wordsArr);

console.log(resultsWordsArr);
...
const resultWordsFind = doesWordExist(wordsFind);
console.log(resultWordsFind);
